...
public class AuthenticationStaffService {
    ...
    public AuthenticationStaffResponse authenticate(AuthenticationStaffRequest request){
        var user = staffRepository.findByUsername(request.getUsername())
        ...
        return new AuthenticationStaffResponse(token, true);
    }

    private String generateToken(String username){
        int staffId = staffService.getStaffIdByUsername(username);
        String role = staffService.getRoleByUsername(username);
